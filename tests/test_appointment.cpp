// Depends on: src/appointment_server.cpp, include/common.h, third_party/sha256.cpp
// Compile via: make test_appointment
//
// NOTE: AppointmentServer::appointmentData must be declared public for the
// direct size checks below to compile.

#define DOCTEST_CONFIG_IMPLEMENT_WITH_MAIN
#include "../third_party/doctest.h"
#include "../src/appointment_server.cpp"
