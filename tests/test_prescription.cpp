// Depends on: src/prescription_server.cpp, include/common.h, third_party/sha256.cpp
// Compile via: make test_prescription
//
// NOTE: PrescriptionServer::prescriptions must be declared public for the
// direct access in the tests below to compile.
